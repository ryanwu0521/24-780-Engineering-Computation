/*
  ===============================
 || XXX   XXXX        XX    XXXX||
 ||   X X XXXX XXXX X    XX XXXX||  Ryan Wu (ID:weihuanw) based on Dr.Nestor Gomez's code
...
public:
	...
	void findShortestPath(int startVertex, int endVertex, std::vector<std::vector<int>>& graph);
